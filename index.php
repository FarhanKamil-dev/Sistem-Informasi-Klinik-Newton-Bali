...
<html lang="id">
  ...
  <title>Klinik Newton | Pengobatan Penyakit Kulit & Kelamin</title>

  <!-- Favicon -->
  <link rel="icon" href="uploads/iconnewton.ico" type="image/x-icon">

  <!-- SEO -->
  <meta name="description" content="Klinik Newton adalah tempat pengobatan terpercaya untuk penyakit kulit dan kelamin dengan layanan konsultasi online.">
  <meta name="keywords" content="klinik kelamin, penyakit kulit, penyakit kelamin, pengobatan penyakit kelamin, klinik Newton">
  <meta name="author" content="Klinik Newton">
...
<nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
  <div class="container">
    <a class="navbar-brand" href="index.php">
      <img src="uploads/logo_klinik_newton.png" alt="Logo Klinik Newton" height="100">
    </a>
...
<div class="container info-section">
  <div class="info-card">
    ...
    <a href="tel:087889075748" class="contact">
      <i class="fas fa-phone me-2"></i>0811 6012 124
    </a>
  </div>

  <div class="info-card">
    <h2><i class="fas -dot me-2"></i>Lokasi Klinik Newton</h2>
    <div class="info"><i class="fas fa-map-marker-alt me-2"></i>Jl. Patih Jelantik No.12 A, Legian, Kec. Kuta, Kabupaten Badung, Bali 80361</div>
  </div>
</div>
...
<div class="container py-5">
    <div class="custom-elegant-card p-4">
  <h2 class="mb-4">Klinik Newton</h2>
  <div class="row">
    <!-- Konten Teks -->
    <div class="col-md-8 order-2 order-md-1">
      <p style="text-align: justify;">
        Klinik Newton adalah klinik pengobatan khusus yang menangani beragam keluhan mengenai penyakit kulit dan penyakit kelamin. Telah banyak membantu kesembuhan pasien dengan berbagai tingkat yang ditangani langsung oleh dokter ahli di Klinik Newton serta didukung oleh laboratorium terpercaya untuk memberikan hasil yang akurat.
      </p>

      <p style="text-align: justify;">
        Klinik Newton menawarkan layanan pengobatan penyakit kulit dan kelamin dengan standar pelayanan terbaik dan harga yang terjangkau. Kami sangat mengutamakan privasi Anda. Kerahasiaan dan kenyamanan pasien menjadi prioritas utama sehingga Anda dapat menjalani pengobatan dengan tenang sampai keluhan Anda teratasi sepenuhnya.
      </p>
      ...
      <ul>
        ...
        <li>Meningkatkan profesionalisme dan mutu seluruh dokter, tenaga kesehatan, dan staf Klinik Newton.</li>
    ...
    <div class="col-md-4 order-1 order-md-2 mb-4 mb-md-0 text-md-end text-center">
      <img src="uploads/konsultasi_dokter.jpg" alt="Ruko Klinik Newton" class="img-fluid custom-image shadow-sm">
    </div>
  </div>
</div>
...
<div class="container py-5">
    <div class="custom-elegant-card p-4">
  <h2 class="mb-4">Mengapa Harus Berobat di Klinik Newton</h2>
  <div class="row align-items-center">
    ...
    <div class="col-md-8 order-2 order-md-2">
      <p style="text-align: justify;">
        <strong>Layanan yang disediakan di Klinik Newton:</strong>
      </p>
      ...
      <p style="text-align: justify;">
        <strong>Keunggulan Klinik Newton:</strong>
      </p>
      <ul class="list-unstyled">
  ...
  <div class="container py-4">
    <div class="row">
      ...
      <div class="col-md-6 mb-4 mb-md-0">
        <h5>Kontak:</h5>
        <p><i class="fab fa-whatsapp me-2"></i>0811 6012 124</p>
        <p><i class="fas fa-envelope me-2"></i>newtonmedicalbali@gmail.com</p>
        <p><i class="fab fa-instagram me-2"></i>@newtonmedical</p>
      </div>

      <!-- Kanan: Alamat -->
      <div class="col-md-6 mb-4 mb-md-0">
        <h5>Alamat:</h5>
        <p><i class="fas fa-map-marker-alt me-2"></i>Jl. Patih Jelantik No.12 A, Legian, Kec. Kuta, Kabupaten Badung, Bali 80361</p>
      </div>
    </div>
  </div>

  <div class="bg-dark text-white text-center py-2">
    &copy; <?= date("Y"); ?> Klinik Newton
  </div>
</footer>
...
function openWhatsAppPopup() {
  const link = "https://wa.me/628116012124?text=Halo%20dok,%20saya%20ingin%20konsultasi";
  const width = 500;
  const height = 600;
